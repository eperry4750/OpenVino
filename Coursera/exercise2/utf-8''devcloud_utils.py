...
def submitToDevCloud(script, node_type, script_args=[], files=[]):
    def getJWT():
        ...
        r = requests.get('http://localhost:8880/jwt')
    ...
    #ov_version='openvino2020.3'
    if node_type == "CPU":
        node_flag = '-l nodes=1:tank-870:i5-6500te'
    elif node_type == "GPU":
        node_flag = '-l nodes=1:tank-870:i5-6500te:intel-hd-530'
    elif node_type == "VPU":
        node_flag = '-l nodes=1:tank-870:i5-6500te:iei-mustang-v100-mx8'
    elif node_type == "FPGA":
        node_flag = '-l nodes=1:tank-870:i5-6500te:iei-mustang-f100-a10'
    else:
    ...
    print("Waiting for job to complete. This may take a few minutes.", end ="")
    count = 0
    while True:
